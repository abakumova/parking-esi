...
public class KafkaConfig {
    ...
    public ProducerFactory<String, Object> producerFactory() {
        ...
        config.put(JsonSerializer.TYPE_MAPPINGS, "userrequestmessage:" + UserBalanceMessage.class.getName());
    ...
    @Bean
    public KafkaTemplate<String, UserBalanceMessage> balanceMessageKafkaTemplate() {
        return new KafkaTemplate<>(producerFactoryBalance());
    }

    public ProducerFactory<String, UserBalanceMessage> producerFactoryBalance() {
        Map<String, Object> config = new HashMap<>();
        config.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:9092");
        config.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
        config.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class);
